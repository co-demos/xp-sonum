...
Ce repo contiendra l'ensemble des éléments "custom" propres au projet de partage d'expériences SoNum, indépendamment du code source d'Apiviz. Ceci permettra une meilleure flexibilité et coordination : 
...
- les issues propres au projet de cartographie SoNum seront associées à [ce repo](https://github.com/co-demos/xp-sonum/issues)
